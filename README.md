...
Open [http://localhost:1024](http://localhost:1024) to view it in your browser.
This project runs on port 1024 to manage  data (from useFetch hook) simultaneously in home and rent pages.
